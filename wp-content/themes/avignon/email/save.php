                        ...
                        <tr width="540">
                            <td width="540" valign="top" style="font-family: TimesNewRoman, 'Times New Roman', Times, Baskerville, Georgia, serif; font-weight: normal; font-size: 14px;">
                                <p style="color: #000; font-family: TimesNewRoman, 'Times New Roman', Times, Baskerville, Georgia, serif; font-weight: normal; font-size: 14px; line-height: 16px;">
                                    You may complete this form at any time by using this link:<br/><br/>
                                    <a href="<?php echo $save_url ?>" style="font-family: TimesNewRoman, 'Times New Roman', Times, Baskerville, Georgia, serif; font-weight: normal; color: #942814; text-decoration: none;"><?php echo $save_url ?></a><br/><br/>
                                </p>
                                <p style="color: #000; font-family: TimesNewRoman, 'Times New Roman', Times, Baskerville, Georgia, serif; font-weight: normal; font-size: 14px; line-height: 16px;">
                                    Your email address <?php echo $email ?> is linked to this application. You may not submit another application associated with the same email address.
                                </p>
                            </td>
                        </tr>
