 ...
 * @since 2.6.0
 */
define('AUTH_KEY',         'B;e_IrRddUllD&`6tfk=Wq^T^(K7>,zLz{`4zrEH-%JKVp<7agm|,vOjrIqi|ORk');
...
define('NONCE_KEY',        ']1&A-khGlO=#cfD2!.B)y>4.{boI6:.xep Jy?m08w{-cTn4<m/.]hr%EO4@RE!U');
...
define('LOGGED_IN_SALT',   '|.f*[i!iRn}Y;Pr|?!p5(:Z}?yi`u|j$a4mSrzTinJ@+hSaf*<Zwz<,x_r|=H[ZP');
